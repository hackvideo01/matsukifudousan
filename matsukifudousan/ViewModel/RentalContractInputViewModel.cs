...
namespace matsukifudousan.ViewModel
{
    public class RentalContractInputViewModel : BaseViewModel
    {
        ...
        public RentalContractInputViewModel()
        {
            ...
            if (Comfirm == 0)
                {
                    var AddRentalContract = new RentalContactDB()
                {
                        HouseNo = HouseNo,
                        ...
                        RenterOfficeName = RenterOfficeName,
                        RenterOfficePhone = RenterOfficeName,
                        RentName = RentName,
                        RentAddressNo = RentAddressNo,
                        RentAddress = RentAddress,
                        RentPhoneNumber = RentPhoneNumber,
                        RentBirthday = RentBirthday,
                        RentOfficeName = RentOfficeName,
                        RentOfficePhone = RentOfficePhone,
                        JointGuarantorName1 = JointGuarantorName1,
                        JointGuarantorAddressNo1 = JointGuarantorAddressNo1,
                        JointGuarantorAddress1 = JointGuarantorAddress1,
                        JointGuarantorPhone1 = JointGuarantorPhone1,
                        JointGuarantorBirthday1 = JointGuarantorBirthday1,
                        JointGuarantorOfficeName1 = JointGuarantorOfficeName1,
                        JointGuarantorOfficePhone1 = JointGuarantorOfficePhone1,
                        JointGuarantorName2 = JointGuarantorName2,
                        JointGuarantorAddressNo2 = JointGuarantorAddressNo2,
                        JointGuarantorAddress2 = JointGuarantorAddress2,
                        JointGuarantorPhone2 = JointGuarantorPhone2,
                        JointGuarantorBirthday2 = JointGuarantorBirthday2,
                        JointGuarantorOfficeName2 = JointGuarantorOfficeName2,
                        JointGuarantorOfficePhone2 = JointGuarantorOfficePhone2,
                };
                    DataProvider.Ins.DB.RentalContactDB.Add(AddRentalContract);
                    DataProvider.Ins.DB.SaveChanges();
                    Comfirm = 1;
                    MessageBox.Show("賃貸契約が保存されていました。");
                }
